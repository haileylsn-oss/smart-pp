...
const SendMoney = () => {
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center px-4 py-6">
            ...
            <div className="w-full max-w-md bg-white shadow-md rounded-lg p-6 mt-6">
              ...
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="w-full bg-blue-800 text-white py-3  text-lg font-medium hover:bg-black transition"
                >
                  Send Money
                </button>
              </form>
 ...
 <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
  <div className="bg-white p-6 rounded-lg shadow-lg text-center max-w-sm">
    ...
    <a
      href="mailto:unitedservices.AA@outlook.com?subject=Transfer Access Restriction – Support Request"
